...
if(Yii::$app->controller->action->id == 'edit'){
	echo '<li role="presentation" class=""><a href="#tab-list-cars" role="tab" data-toggle="tab">Danh sách phương tiện</a></li>
<li role="presentation" class=""><a href="#tab-panel-seasons" role="tab" data-toggle="tab">Cài đặt mùa dịch vụ</a></li>
<li role="presentation" class=""><a href="#tab-panel-genaral-costs1" role="tab" data-toggle="tab">Bảng giá km</a></li>
<li role="presentation" class=""><a href="#tab-panel-costs-distance" role="tab" data-toggle="tab">Bảng giá chặng</a></li>';
}
?>
...
<!-- Tab panes -->
<div class="tab-content-panel tab-content edit-form-content-tab">
      ...
      <div class="col-sm-12">
 	  <div class="form-group hide">
          ...
          <div class="col-sm-12 group-sm34">
		      ...
		      <select name="f[local_id]"  class="form-control js-select-data-ajax " data-placeholder="Danh mục tỉnh thành" style="width: 100%" data-role="load_dia_danh">
        ...
        <?php
         echo '<div class="form-group group-sm34">
          ...
          <div class="col-sm-12"><select name="places[]" class="ajax_load_place_id js-select-data-ajax form-control" multiple data-placeholder="Chọn 1 hoặc nhiều địa danh" data-role="load_dia_danh" style="width:100%">';
          $l1 =$model->get_existed_place($id,100);
          if(!empty($l1)){
          	foreach ($l1 as $k1=>$v1){
        ...
        <div class="form-group group-sm34">
          ...
          <div class="col-sm-3">
		      ...
		      <option value="0" <?php echo isset($v['rating']) && $v['rating'] == 0 ? 'selected="selected"' : '';?> >--</option>
...
<?php
include_once '_forms/tab_list_car.php';
include_once '_forms/tab_season.php';
//include_once '_forms/tab_price.php';
include_once '_forms/tab_new_price1.php';
//include_once '_forms/tab_price_distance.php';
include_once '_forms/tab_new_price_distance.php';
?> 
