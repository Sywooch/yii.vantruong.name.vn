...
?> 
<div class="col-sm-12 pdt10 " role="main" id="imain"> 
          <div class="">
            <div class="row top_tiles hide" style="margin: 10px 0;">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 widget_tally_box hide">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>User Uptake</h2>
                    <ul class="nav navbar-right panel_toolbox">
