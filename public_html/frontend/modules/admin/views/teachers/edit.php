...
<div class="tab-content edit-form-content-tab">
  ...
  <div role="tabpanel" class="tab-panel active" id="tab-genaral">
        ...
        <div class="row">
        <div class="col-sm-12">
 <label class="fl100 control-label">Mã giáo viên</label> <div class="fl100">       
...
?> 
 ...
 placeholder="Mã giáo viên" value="<?php echo isset($v['code']) ? $v['code'] : '';?>"
...
echo '<div class="form-group group-sm30">
		...
		<div class="col-sm-12"><input type="text" name="f[fname]" class="form-control input-sm required" placeholder="Tên giáo viên" value="'.(isset($v['fname']) ? uh($v['fname']) : '').'"></div>
		</div></div>
