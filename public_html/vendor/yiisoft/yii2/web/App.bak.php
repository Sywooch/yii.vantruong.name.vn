...
class Application extends \yii\base\Application
{
	...
	protected function bootstrap()
	{
		...
		//if($_SERVER['HTTP_HOST'] == 'demo3.dalaco.travel'){
	...
	protected function __registed_domain(){
		...
		defined('DEFAULT_LANG') or define("DEFAULT_LANG", isset($config['default_language']['code']) ? $config['default_language']['code'] : 'vi_VN');
		defined('ADMIN_LANG') or define("ADMIN_LANG",SYSTEM_LANG);
		//view(\izi\web\Slugs::tableName(),true);
	}
